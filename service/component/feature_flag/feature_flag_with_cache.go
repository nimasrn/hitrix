...
func (s *serviceFeatureFlagWithCache) IsActive(ormService fluxaorm.Context, name string) bool {
	if name == "" {
...
func (s *serviceFeatureFlagWithCache) FailIfIsNotActive(ormService fluxaorm.Context, name string) error {
	return s.featureFlagService.FailIfIsNotActive(ormService, name)
}

func (s *serviceFeatureFlagWithCache) Enable(ormService fluxaorm.Context, name string) error {
...
func (s *serviceFeatureFlagWithCache) Disable(ormService fluxaorm.Context, name string) error {
...
func (s *serviceFeatureFlagWithCache) GetScriptsSingleInstance(ormService fluxaorm.Context) []app.IScript {
	return s.featureFlagService.GetScriptsSingleInstance(ormService)
}

func (s *serviceFeatureFlagWithCache) GetScriptsMultiInstance(ormService fluxaorm.Context) []app.IScript {
...
func (s *serviceFeatureFlagWithCache) Sync(ormService fluxaorm.Context, clockService clock.IClock) {
