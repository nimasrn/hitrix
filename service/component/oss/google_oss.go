...
func (ossStorage *GoogleOSS) UploadObjectFromFile(ormService fluxaorm.Context, namespace Namespace, localFile string) (entity.FileObject, error) {
...
func (ossStorage *GoogleOSS) UploadImageFromFile(ormService fluxaorm.Context, namespace Namespace, localFile string) (entity.FileObject, error) {
