...
func (ossStorage *AmazonOSS) UploadObjectFromFile(ormService fluxaorm.Context, namespace Namespace, localFile string) (entity.FileObject, error) {
...
func (ossStorage *AmazonOSS) UploadImageFromFile(ormService fluxaorm.Context, namespace Namespace, localFile string) (entity.FileObject, error) {
