...
func (m *Sender) SendTemplate(_ fluxaorm.Context, message *mail.Message) error {
	return m.Called(message.To).Error(0)
}

func (m *Sender) SendTemplateWithAttachments(_ fluxaorm.Context, message *mail.MessageAttachment) error {
	return m.Called(message.To).Error(0)
}
